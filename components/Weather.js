  ...
  render() {
    ...
    var data =
      this.props.weather && this.props.weather.futur
        ? this.convertToChartPieData(this.props.weather.futur)
        : [];
    return (
      <div className="weather">
        ...
        <DataList
          data={[
            {
              title: "Time",
              value: moment(this.props.weather.time).format("hh:mm")
            },
        ...
        <Row alignXs="center" valignXs="middle">
          <Column autoXs>
            <Content>
              {this.props.weather && this.props.weather.futur ? (
                <ChartLine width={width} height={height} data={data} />
              ) : null}
            </Content>
          </Column>
        </Row>
