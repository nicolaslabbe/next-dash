...
class ChartLine extends React.Component {
  ...
  render () {
    const axisBottom = {orient:"bottom", tickSize:0, tickPadding:10, tickRotation:0, legend:"", legendOffset:36, legendPosition:"center"}
    const axisLeft = {orient:"left", tickSize:0, tickPadding:10, tickRotation:0, legend:"", legendOffset:-40, legendPosition:"center"}
